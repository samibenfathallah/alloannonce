...
", 0, '', 'L', 'true');
    ...
    public function EditContactAction() {
        ...
        return $this->render('@Backoffice/Default/formcontact.html.twig', array('info' => $info));
    }
    ...
    public function ViewContactAction() {
        ...
        $info = $this->getDoctrine()->getRepository(Info::class)->findAll();
        return $this->render('@Backoffice/Default/contact.html.twig', array('infos' => $info));
    }
    ...
    public function valideeditContactAction() {
        ...
        /* print_r($services);
          die(); */
        return $this->redirectToRoute('visualiser_contact');
    }
